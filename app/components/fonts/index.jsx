...
var BoldnessLevels;
(function (BoldnessLevels) {
    BoldnessLevels[BoldnessLevels["Light"] = 0] = "Light";
    BoldnessLevels[BoldnessLevels["Normal"] = 1] = "Normal";
    BoldnessLevels[BoldnessLevels["Medium"] = 2] = "Medium";
    BoldnessLevels[BoldnessLevels["Semibold"] = 3] = "Semibold";
    BoldnessLevels[BoldnessLevels["Bold"] = 4] = "Bold";
})(BoldnessLevels || (BoldnessLevels = {}));
const BaseFont = ({ children, boldness, tag, ...props }) => {
    const tagType = typeof tag === 'string' ? tag : 'div'; // default to div
    const factory = React.createFactory(tagType);
    return factory(props, children);
};
const getRockwellBoldness = (boldnessLevel) => {
...
const getWorkSansBoldness = (boldnessLevel) => {
...
const Display4 = styled(BaseFont) `
  ...
  font-weight: ${props => getRockwellBoldness(props.boldness !== undefined ? props.boldness : BoldnessLevels.Normal)};
  font-size: 32px;
  line-height: 32px;
`;
const Display3 = styled(BaseFont) `
  font-family: 'Rockwell';
  font-weight: ${props => getRockwellBoldness(props.boldness !== undefined ? props.boldness : BoldnessLevels.Light)};
  font-size: 72px;
  line-height: 80px;
`;
...
const Display1 = styled(BaseFont) `
  ...
  font-weight: ${props => getWorkSansBoldness(props.boldness !== undefined ? props.boldness : BoldnessLevels.Normal)};
  font-size: 40px;
  line-height: 46px;
`;
/*  'H' fonts (headers)  */
...
const Label = styled(BaseFont) `
  ...
  line-height: 14px;
`;
export { Display1, Display2, Display3, Display4, H1, H2, H3, H4, Body1, Body2, Body3, Link1, Link2, Link3, Link4, Label, BoldnessLevels, };
